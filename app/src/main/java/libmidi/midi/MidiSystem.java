...
package libmidi.midi;

import libmidi.sound.StandardMidiFileReader;
import libmidi.sound.StandardMidiFileWriter;
import libmidi.midi.spi.MidiDeviceProvider;
import libmidi.midi.spi.MidiFileReader;
import libmidi.midi.spi.MidiFileWriter;
 ...
 * <tbody>
 *   <tr>
 *     <th scope="row">{@code libmidi.midi.Receiver}
 *     <td>{@link Receiver}
 *     <td>{@link #getReceiver}
 *   <tr>
 *     <th scope="row">{@code libmidi.midi.Sequencer}
 *     <td>{@link Sequencer}
 ...
 *   <tr>
 *     <th scope="row">{@code libmidi.midi.Transmitter}
 *     <td>{@link Transmitter}
 ...
 * <p>
 * For example, the property {@code libmidi.midi.Receiver} with a value
...
public class MidiSystem {
     ...
     * <p>
     * If the system property {@code libmidi.midi.Receiver} is defined or it
     ...
     * <p>
     * If the system property {@code libmidi.midi.Transmitter} is defined or
     ...
     * <p>
     * If the system property {@code libmidi.midi.Sequencer} is defined or
     * it is defined in the file "sound.properties", it is used to identify the
